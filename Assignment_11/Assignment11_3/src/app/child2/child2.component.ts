...
{
  public Books : string[] = ["Essential Angular by Adam Freeman",
  "Beginning Node.js by Greg Lim","Express.js Guide by Azat", 
  ...
  "Artificial Intelligence and Machine Learning by Vinod Chandra S. S"];
